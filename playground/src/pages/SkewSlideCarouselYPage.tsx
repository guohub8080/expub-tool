...
export default function SkewSlideCarouselYPage() {
  return (
    <div>
      ...
      <div style={{ border: '1px solid #e5e7eb', borderRadius: 8, padding: 16, marginBottom: 16, maxWidth: 600 }}>
        <h3 style={{ margin: '0 0 8px' }}>5 图 — 随机 L/R 组合</h3>
        <SkewSlideCarouselY
          canvasSize={{ w: 300, h: 500 }}
          items={[
      ...
      <div style={{ border: '1px solid #e5e7eb', borderRadius: 8, padding: 16, marginBottom: 16, maxWidth: 600 }}>
        <h3 style={{ margin: '0 0 8px' }}>3 图 — 全部 R→R（同向）</h3>
        <SkewSlideCarouselY
          canvasSize={{ w: 300, h: 500 }}
          items={[
            { url: getWechat300x300(1), skewIn: 'R', skewOut: 'R' },
            { url: getWechat300x300(2), skewIn: 'R', skewOut: 'R' },
            { url: getWechat300x300(3), skewIn: 'R', skewOut: 'R' },
          ]}
        />
      </div>
