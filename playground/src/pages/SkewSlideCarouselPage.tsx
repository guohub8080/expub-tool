  ...
  return (
    <div>
      ...
      <div style={{ border: '1px solid #e5e7eb', borderRadius: 8, padding: 16, marginBottom: 16, maxWidth: 600 }}>
        <h3 style={{ margin: '0 0 8px' }}>5 图 — 默认（300×300）</h3>
        <SkewSlideCarousel
      ...
      <div style={{ border: '1px solid #e5e7eb', borderRadius: 8, padding: 16, marginBottom: 16, maxWidth: 600 }}>
        <h3 style={{ margin: '0 0 8px' }}>5 图 — isReversed</h3>
        <SkewSlideCarousel
          canvasSize={{ w: 300, h: 300 }}
          isReversed
          childItems={[
      ...
      <div style={{ border: '1px solid #e5e7eb', borderRadius: 8, padding: 16, marginBottom: 16, maxWidth: 600 }}>
        <h3 style={{ margin: '0 0 8px' }}>3 图 — childCanvasSize=200×200，canvas 300×300（三面可见）</h3>
        <SkewSlideCarousel
          canvasSize={{ w: 300, h: 300 }}
      ...
      <div style={{ border: '1px solid #e5e7eb', borderRadius: 8, padding: 16, marginBottom: 16, maxWidth: 600 }}>
        <h3 style={{ margin: '0 0 8px' }}>2 图 — normalize 到 6 张</h3>
        <SkewSlideCarousel
          canvasSize={{ w: 300, h: 300 }}
          childCanvasSize={{ w: 200, h: 200 }}
          childItems={[
