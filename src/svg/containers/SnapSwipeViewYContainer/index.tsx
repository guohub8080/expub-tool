 ...
 * 纵向吸附滑动视口容器（抖音效果）
 *
 * 在 SwipeViewYContainer 基础上增加 scroll snap 吸附效果，
 * 滑动松手后自动对齐到最近的一页。
 *
 * @param items       - 子组件数组
 ...
 * @param spacing     - 外边距配置
 */
const SnapSwipeViewYContainer = (props: {
  items?: ReactNode[]
  ...
  return (
    <SectionEx
      {...(isDev ? { 'expubgo-label': 'snap-swipe-view-y-container' } : {})}
      style={{
...
export default SnapSwipeViewYContainer
